...
(function() {
  ...
  module.exports = AdminRoute = (function() {
    ...
    AdminRoute.prototype.addRequestHandlers = function() {
      ...
      this.app.post('/admin/queryFilteredNames', _.bind(this.handleAjaxQueryFilteredNames, this));
      this.app.post('/admin/delPreviewedNames', _.bind(this.handleAjaxDeleteFilteredNames, this));
      return this.app.post('/admin/delAName', _.bind(this.handleAjaxDeleteAName, this));
    };
    ...
    AdminRoute.prototype.handleAjaxQueryFilteredNames = function(req, res) {
    ...
    AdminRoute.prototype.handleAjaxDeleteFilteredNames = function(req, res) {
      var conditions, filter, filters;
      filters = req.body.filters;
      should.exist(filters, "Query parameter 'req.body.filters' cannot be null");
      if (filters === '') {
    ...
    AdminRoute.prototype.handleAjaxDeleteAName = function(req, res) {
      var id;
      id = req.body.id;
      should.exist(id, "Query parameter 'req.body.id' cannot be null");
      return NameCandidate.findOneAndRemove({
        "_id": id
      }, function(err) {
        if (err) {
          return res.json(500);
    ...
    AdminRoute.prototype.__batchAddNames = function(names, cb) {
      ...
      return async.eachSeries(names.split(","), iterator, cb);
    };
